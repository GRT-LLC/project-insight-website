...
import { MapPin, Check, ChevronDown, Menu, X, Star, Globe, Shield, Clock, CreditCard, Smartphone, ArrowRight, Users, Calendar, DollarSign, Plane, Hotel, Utensils, Camera, Heart, Zap, Mail, Phone, MessageCircle, Facebook, Twitter, Instagram, Linkedin, ChevronRight, Send, Sparkles, Bell, AlertCircle } from 'lucide-react';
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white rounded-2xl shadow-xl p-4 mb-4">
            ...
            <button
              ...
              className="w-full mt-4 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-medium hover:from-blue-700 hover:to-purple-700 transition-all"
            >
              Join Waitlist
            </button>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-6">
              Get travel tips, product updates, and early access to new features
            </p>
            {subscribed ? (
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transition-all"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Your personal AI travel assistant. Plan, book, and experience unforgettable journeys.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
    ...
    <div>
      ...
      <section className="relative h-[95vh] min-h-[600px]">
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=1920')`,
          }}
        >
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl text-center mb-8 max-w-3xl drop-shadow-lg">
            Your personal AI travel assistant that plans, books, and guides your perfect journey
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() => navigate('waitlist')}
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-xl"
            >
              Join the Waitlist
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Jarvis handles every aspect of your journey, from planning to memories
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Real-time expense tracking with smart budget alerts and insights'
              },
              {
                icon: MessageCircle,
              ...
              },
              {
                icon: Camera,
                title: 'Trip Journal',
                description: 'Automatically capture and organize your travel memories'
              },
              {
                icon: Users,
                title: 'Group Coordination',
                description: 'Easy planning and expense splitting for group trips'
              },
              {
                icon: Shield,
                title: 'Secure & Private',
                description: 'Bank-level encryption for your data and payment information'
              }
            ].map((feature, index) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6">
                Introducing Fatigue Index™
              </h2>
              <p className="text-xl text-blue-100 mb-6">
                Our proprietary algorithm monitors your travel fatigue in real-time, considering factors like jet lag, sleep patterns, and activity levels to ensure you never overextend yourself.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-blue-200">6h</div>
                  <div className="text-sm text-blue-300">Sleep Last Night</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-blue-200">+2h</div>
                  <div className="text-sm text-blue-300">Time Zone Shift</div>
                </div>
                <div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                ...
                {index < 3 && (
                  <ChevronRight className="w-6 h-6 text-blue-400 mx-auto mt-4 hidden md:block" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 text-center mb-12">
            Early access users are already loving JarvisTravel
          </p>
          
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "The Fatigue Index feature alone is worth it. I used to come home from trips more exhausted than when I left!",
                name: "Sarah M.",
                role: "Frequent Traveler",
                rating: 5
              },
              {
                quote: "Planning our family trip to Japan was effortless. Jarvis handled everything from flights to restaurant reservations.",
                name: "Michael T.",
                role: "Family Travel",
                rating: 5
              },
              {
                quote: "As a business traveler, the budget tracking and expense reports have saved me hours every month.",
                name: "Jennifer L.",
  ...
  const features = [
    {
      icon: Calendar,
      title: 'Smart Itinerary Planning',
      description: 'AI analyzes your preferences, travel history, and millions of data points to create perfectly optimized itineraries. Never miss a hidden gem or waste time on tourist traps.',
      highlights: ['Personalized recommendations', 'Time optimization', 'Local insights']
    },
    {
      icon: CreditCard,
      title: 'Intelligent Budget Management',
      description: 'Track expenses in real-time, get spending alerts, and receive smart suggestions to maximize your travel budget without sacrificing experiences.',
      highlights: ['Real-time tracking', 'Currency conversion', 'Split expenses']
    },
    {
      icon: MessageCircle,
      title: '24/7 AI Concierge',
      description: 'Your personal travel assistant is always available. Get instant help with bookings, local recommendations, translations, and emergency support.',
      highlights: ['Instant responses', 'Multi-language support', 'Emergency assistance']
    },
    {
      icon: Camera,
      title: 'Automatic Trip Journal',
      description: 'Capture memories effortlessly with AI-powered photo organization, automatic location tagging, and beautiful shareable trip summaries.',
      highlights: ['Auto-organization', 'Location tagging', 'Shareable albums']
    },
    {
      icon: Users,
      title: 'Group Trip Coordination',
      description: 'Planning with friends or family? Coordinate schedules, split costs fairly, and ensure everyone has input on the itinerary.',
      highlights: ['Shared planning', 'Fair cost splitting', 'Group voting']
    },
    {
      icon: Zap,
      title: 'Fatigue Index™',
      description: 'Our exclusive technology monitors your energy levels based on jet lag, sleep, and activity to prevent travel burnout and optimize your experience.',
      highlights: ['Energy tracking', 'Rest recommendations', 'Activity balancing']
    },
    {
      icon: Globe,
      title: 'Offline Access',
      description: 'Download your complete itinerary, maps, and essential information for offline use. Stay informed even without internet connection.',
      highlights: ['Offline maps', 'Downloaded itineraries', 'Emergency info']
    },
    {
      icon: Shield,
      title: 'Bank-Level Security',
      description: 'Your data is protected with 256-bit encryption, two-factor authentication, and strict privacy controls. Your travel data stays yours.',
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Choose the perfect plan for your travel needs. Cancel anytime.
          </p>
...
function ContactPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In production, this would submit to your contact form API
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href="https://twitter.com/jarvistravel" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">@jarvistravel</a>
                    </div>
                  </div>
                </div>
              </div>
...
// ============================================================================
// WAITLIST PAGE MODULE (Replaces Sign In/Sign Up)
// ============================================================================
        ...
        {submitted ? (
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Thanks for joining the JarvisTravel waitlist, {formData.name}!
            </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">We'll send you a confirmation email shortly</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                    <span className="text-sm font-bold text-blue-600">2</span>
                  </div>
                  <span className="text-gray-600">You'll receive early access when we launch</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                    <span className="text-sm font-bold text-blue-600">3</span>
                  </div>
                  <span className="text-gray-600">Get 30% off your first year as a waitlist member</span>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transition-all flex items-center justify-center">
            ...
            <div className="md:col-span-2">
              <div className="sticky top-24">
                ...
                <p className="text-gray-600 mb-8">
                  Be among the first to experience AI-powered travel planning when we launch.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-3">
                      What types of travel interest you? (Select all that apply)
                    </label>
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg"
                  >
                    Join the Waitlist
                  </button>
                  ...
                  <p className="text-center text-sm text-gray-500">
                    ...
                    <button type="button" onClick={() => navigate('privacy')} className="text-blue-600 hover:text-blue-800">
                      Privacy Policy
                    </button>
                    {' '}and{' '}
                    <button type="button" onClick={() => navigate('terms')} className="text-blue-600 hover:text-blue-800">
                      Terms of Service
                    </button>
                  </p>
                </form>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              ...
              travel preferences, and payment information when you subscribe to our services.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              You can also object to processing and request data portability where applicable.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">Contact Us</h2>
            <p className="text-gray-600 mb-6">
              If you have any questions about this Privacy Policy, please contact us at{' '}
              <a href="mailto:privacy@jarvistravel.com" className="text-blue-600 hover:text-blue-800">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              By accessing or using JarvisTravel, you agree to be bound by these Terms of Service 
            ...
            <p className="text-gray-600 mb-6">
              JarvisTravel shall not be liable for any indirect, incidental, special, consequential, 
            ...
            <p className="text-gray-600 mb-6">
              ...
              <a href="mailto:legal@jarvistravel.com" className="text-blue-600 hover:text-blue-800">
                legal@jarvistravel.com
              </a>
            </p>
          </div>
        </div>
