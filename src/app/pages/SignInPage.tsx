        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-amber-400 text-gray-900 rounded-xl font-semibold hover:shadow-lg hover:shadow-amber-400/25 transition-all disabled:opacity-50"
            >
